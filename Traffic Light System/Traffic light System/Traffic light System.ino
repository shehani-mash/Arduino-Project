int Lane1[] = {10,9,8}; // Lane 1 Red, Yellow and Green
int Lane2[] = {13,12,11};// Lane 2 Red, Yellow and Green
int Lane3[] = {4,3,2};// Lane 3 Red, Yellow and Green
int Lane4[] = {7,6,5};// Lane 4 Red, Yellow and Green
